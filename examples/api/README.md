...
- **API.ipynb**: built by `scripts/build_api_notebook.py` (`make api-notebook`); categories are listed explicitly in `CATEGORIES` inside that script (includes `mdanalysis`, `visualize`, …).

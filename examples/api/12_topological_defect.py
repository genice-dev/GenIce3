...
genice.spot_hydroniums = find_nearest_sites_pbc(H3O_positions, genice.lattice_sites, genice.cell)
genice.spot_hydroxides = find_nearest_sites_pbc(OH_positions, genice.lattice_sites, genice.cell)
